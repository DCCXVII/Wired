...
public class Button extends JButton {
  ...
  /**
   * Retrieves the effect color of the object.
   *
   ...
   *
   * @param  effectColor  the color to set as the effect color
   */
  ...
  private float alpha;
  private Color effectColor = new Color(25, 118, 211);
  ...
  /**
   * Paints the component by rendering an image on the graphics object.
   *
